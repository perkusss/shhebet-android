...
.method static constructor <clinit>()V
    ...
    .line 9
    .line 10
    sput-object v0, LI/z;->a:Landroid/graphics/RectF;
...
.method public static b(Landroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    .line 5
    .line 6
    invoke-static {v0}, LI/z;->c(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public static c(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
    ...
    .line 5
    .line 6
    sget-object v1, LI/z;->a:Landroid/graphics/RectF;
...
.method public static d(Landroid/graphics/RectF;Landroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    .line 2
    invoke-static {p0, p1, p2, v0}, LI/z;->e(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public static e(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
    ...
    .line 26
    :cond_0
    invoke-static {p1}, LI/z;->c(Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public static f(Landroid/graphics/Rect;I)Landroid/util/Size;
    ...
    .line 1
    invoke-static {p0}, LI/z;->m(Landroid/graphics/Rect;)Landroid/util/Size;
    ...
    .line 5
    invoke-static {p0, p1}, LI/z;->p(Landroid/util/Size;I)Landroid/util/Size;
...
.method public static j(Landroid/util/Size;Landroid/util/Size;)Z
    ...
    .line 2
    invoke-static {p0, v0, p1, v0}, LI/z;->k(Landroid/util/Size;ZLandroid/util/Size;Z)Z
...
.method public static l(Landroid/graphics/Matrix;)Z
    ...
    .line 21
    .line 22
    invoke-static {v1, v3, v4, v0}, LI/z;->a(FFFF)F
...
.method public static p(Landroid/util/Size;I)Landroid/util/Size;
    ...
    .line 37
    .line 38
    invoke-static {p0}, LI/z;->o(Landroid/util/Size;)Landroid/util/Size;
...
.method public static q(Landroid/util/Size;)Landroid/graphics/Rect;
    ...
    .line 2
    invoke-static {p0, v0, v0}, LI/z;->r(Landroid/util/Size;II)Landroid/graphics/Rect;
...
.method public static s(Landroid/util/Size;)Landroid/graphics/RectF;
    ...
    .line 2
    invoke-static {p0, v0, v0}, LI/z;->t(Landroid/util/Size;II)Landroid/graphics/RectF;

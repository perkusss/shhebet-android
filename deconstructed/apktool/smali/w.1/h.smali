...
.method private b(Ljava/util/Set;)V
    ...
    .line 21
    invoke-virtual {v1, v0}, Ls/h2$c;->t(Ls/h2;)V
...
# virtual methods
.method public c(Ls/h2;Ljava/util/List;Ljava/util/List;Lw/h$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :goto_1
    invoke-direct {p0, v0}, Lw/h;->b(Ljava/util/Set;)V

    .line 36
    .line 37
    .line 38
    :cond_2
    invoke-interface {p4, p1}, Lw/h$a;->a(Ls/h2;)V
    ...
    :cond_4
    :goto_3
    invoke-direct {p0, p2}, Lw/h;->a(Ljava/util/Set;)V
...
.method public d()Z
    ...
    .line 1
    iget-object v0, p0, Lw/h;->a:Landroidx/camera/camera2/internal/compat/quirk/CaptureSessionOnClosedNotCalledQuirk;

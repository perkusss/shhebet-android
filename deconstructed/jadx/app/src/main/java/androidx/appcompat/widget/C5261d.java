...
public class C5261d extends AutoCompleteTextView implements InterfaceC5522m {

    /* JADX INFO: renamed from: d */
    private static final int[] f21762d = {R.attr.popupBackground};

    /* JADX INFO: renamed from: a */
    private final C5263e f21763a;

    /* JADX INFO: renamed from: b */
    private final C5186A f21764b;

    /* JADX INFO: renamed from: c */
    private final C5277l f21765c;

    public C5261d(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C9424a.f40613p);
    }

    /* JADX INFO: renamed from: a */
    void m20591a(C5277l c5277l) {
    ...
    protected void drawableStateChanged() {
        ...
        C5263e c5263e = this.f21763a;
        if (c5263e != null) {
            c5263e.m20596b();
        }
        C5186A c5186a = this.f21764b;
        if (c5186a != null) {
            c5186a.m20145b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f21764b.m20152j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f21764b.m20153k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f21765c.m20680d(C5281n.m20690a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z10) {
        this.f21765c.m20681e(z10);
    }

    @Override // android.widget.TextView
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f21765c.m20677a(keyListener));
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f21764b.m20165w(colorStateList);
        this.f21764b.m20145b();
    }

    @Override // androidx.core.widget.InterfaceC5522m
    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f21764b.m20166x(mode);
        this.f21764b.m20145b();
    }
    ...
    public C5261d(Context context, AttributeSet attributeSet, int i10) {
        super(C5262d0.m20593b(context), attributeSet, i10);
        C5258b0.m20563a(this, getContext());
        C5268g0 c5268g0M20608v = C5268g0.m20608v(getContext(), attributeSet, f21762d, i10, 0);

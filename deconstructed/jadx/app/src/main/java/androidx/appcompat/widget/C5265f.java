...
public class C5265f extends CheckBox implements InterfaceC5521l, InterfaceC5522m {

    /* JADX INFO: renamed from: a */
    private final C5271i f21780a;

    /* JADX INFO: renamed from: b */
    private final C5263e f21781b;

    /* JADX INFO: renamed from: c */
    private final C5186A f21782c;

    /* JADX INFO: renamed from: d */
    private C5279m f21783d;

    public C5265f(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C9424a.f40615r);
    }

    private C5279m getEmojiTextViewHelper() {
        if (this.f21783d == null) {
            this.f21783d = new C5279m(this);
        }
        return this.f21783d;
    }
    ...
    protected void drawableStateChanged() {
        ...
        C5263e c5263e = this.f21781b;
        if (c5263e != null) {
            c5263e.m20596b();
        }
        C5186A c5186a = this.f21782c;
        if (c5186a != null) {
            c5186a.m20145b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f21782c.m20152j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f21782c.m20153k();
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f21782c.m20165w(colorStateList);
        this.f21782c.m20145b();
    }

    @Override // androidx.core.widget.InterfaceC5522m
    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f21782c.m20166x(mode);
        this.f21782c.m20145b();
    }

    public C5265f(Context context, AttributeSet attributeSet, int i10) {

...
public final class MultiDex {
    ...
    private static final class V14 {
        ...
        private static class ICSElementConstructor implements ElementConstructor {
            ...
            ICSElementConstructor(Class<?> cls) throws NoSuchMethodException {
        ...
        private static class JBMR11ElementConstructor implements ElementConstructor {
            ...
            JBMR11ElementConstructor(Class<?> cls) throws NoSuchMethodException {
        ...
        private static class JBMR2ElementConstructor implements ElementConstructor {
            ...
            JBMR2ElementConstructor(Class<?> cls) throws NoSuchMethodException {
        ...
        static void install(ClassLoader classLoader, List<? extends File> list) throws IllegalAccessException, NoSuchFieldException {
    ...
    private static final class V19 {
        ...
        static void install(ClassLoader classLoader, List<? extends File> list, File file) throws IllegalAccessException, NoSuchFieldException, IOException {
    ...
    private static final class C5792V4 {
        private C5792V4() {
        }

        static void install(ClassLoader classLoader, List<? extends File> list) throws IllegalAccessException, NoSuchFieldException {
            int size = list.size();
            Field fieldFindField = MultiDex.findField(classLoader, RichPath.TAG_NAME);
    ...
    private static void doInstallation(Context context, File file, File file2, String str, String str2, boolean z10) {

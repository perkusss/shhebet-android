...
public final class C2966a implements InterfaceC1782s {

    /* JADX INFO: renamed from: a */
    private final InterfaceC1782s f12578a;

    public C2966a(int i10) {
        if ((i10 & 1) != 0) {
            this.f12578a = new C1756O(65496, 2, "image/jpeg");
        } else {
            this.f12578a = new C2967b();
        }
    }
    ...
    public boolean mo2037i(InterfaceC1783t interfaceC1783t) {
        return this.f12578a.mo2037i(interfaceC1783t);
    }

    @Override // p146I1.InterfaceC1782s
    public void release() {
        this.f12578a.release();
    }
}

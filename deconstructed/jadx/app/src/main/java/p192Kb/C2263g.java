...
public class C2263g extends AbstractC2262f {

    /* JADX INFO: renamed from: Kb.g$a */
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f10382a[EnumC13629a.SCHEDULE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f10382a[EnumC13629a.BACK.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f10382a[EnumC13629a.CANCEL.ordinal()] = 4;
    ...
    public static AbstractC2262f m9919Z4(Bundle bundle) {
        C2263g c2263g = new C2263g();
        c2263g.setArguments(bundle);
        return c2263g;
    }
    ...
    public C8354p mo9373C2() {
        return new C8354p(this.f9487h0.getSelectPickupList());
    }

    @Override // p156Ib.AbstractC1909n, p849yb.InterfaceC13365c
    /* JADX INFO: renamed from: F1 */
    public void mo8772F1(C8348j c8348j) {
        C8335b.m35780F(mo8799z().longValue()).m35809M().order = c8348j.getOrder();
        this.f10372Q0.setText(c8348j.getTitle());
        mo8779O0().setPickupMarker(c8348j);
    ...
    public EnumC13633a mo9376a3() {
        return EnumC13633a.MAP_TRACKING_PICKUP_LIST;
    }
    ...
    public void mo9914d1() {
        ...
        C0668d c0668d = new C0668d(mo8799z().longValue(), this.f10379X0, this, "PICKUP");
    ...
    public void onEvent(C10748k c10748k) {
        ...
        if (c10748k.f47985a.size() == 0) {
            ...
            this.f10371P0.setText("No Record Found");
        } else {
    ...
    public void mo8800z4() {
        this.f10367L0 = (RecyclerView) this.f9486g0.findViewById(R.id.pickup_recycler_view);

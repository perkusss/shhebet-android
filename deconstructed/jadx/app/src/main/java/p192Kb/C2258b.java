...
public class C2258b extends AbstractC2262f {
    /* JADX INFO: renamed from: Z4 */
    public static /* synthetic */ void m9911Z4(C2258b c2258b, View view) {
        ActivityC5685t activity = c2258b.getActivity();
        Objects.requireNonNull(activity);
        if (activity.getSupportFragmentManager() != null) {
            c2258b.mo1408A3(true);
        }
    }

    /* JADX INFO: renamed from: a5 */
    public static AbstractC0337f m9912a5(Bundle bundle) {
        C2258b c2258b = new C2258b();
        c2258b.setArguments(bundle);
        return c2258b;
    }

    /* JADX INFO: renamed from: b5 */
    private void m9913b5() {
    ...
    public C8354p mo9373C2() {
        return new C8354p(this.f9487h0.getCheckin());
    }
    ...
    public EnumC13633a mo9376a3() {
        return EnumC13633a.MAP_TRACKING_CKECKIN;
    }
    ...
    public void mo9914d1() {
        ...
        C0666b c0666b = new C0666b(C8335b.m35780F(mo8799z().longValue()).m35806I().getMapId(), mo8799z().longValue(), "CheckinFragment", (InterfaceC2406a) getActivity(), this.f10380Y0, this);
    ...
    public void onEvent(C10739b c10739b) {
        C0734c.m3644c().m3659p(C10739b.class);
        if (c10739b.f47964b != mo8799z().longValue()) {
            return;
        }
        if (c10739b.f47963a.size() == 0) {
            this.f10371P0.setVisibility(0);
            this.f10371P0.setText(R.string.no_records_found);
        } else {
            this.f10377V0.m3429n0(c10739b.f47963a);
        }
    ...
    protected void mo8790p4() {
        this.f2691l.setNavigationOnClickListener(new ViewOnClickListenerC2257a(this));
    }
    ...
    @InterfaceC0741j(sticky = true, threadMode = ThreadMode.MAIN)
    public void onEvent(C10740c c10740c) {
        C0734c.m3644c().m3659p(C10740c.class);
        this.f10377V0.m3431p0(c10740c);
    }

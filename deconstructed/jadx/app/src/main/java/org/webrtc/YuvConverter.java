...
public final class YuvConverter {
    ...
    private static class ShaderCallbacks implements GlGenericDrawer.ShaderCallbacks {
        ...
        /* synthetic */ ShaderCallbacks(C11162P0 c11162p0) {
            this();
        }
    ...
    private VideoFrame.I420Buffer convertInternal(VideoFrame.TextureBuffer textureBuffer) {
        ...
        return JavaI420Buffer.wrap(width, height, byteBufferSlice, i10, byteBufferSlice2, i10, byteBufferSlice3, i10, new RunnableC11160O0(byteBufferNativeAllocateByteBuffer));
    }
    ...
    public VideoFrame.I420Buffer convert(VideoFrame.TextureBuffer textureBuffer) {
        try {
            ...
            Logging.m46077w(TAG, "Failed to convert TextureBuffer", e10);
            return null;
        }
    }

...
public class RtpParameters {
    ...
    public static class Encoding {
        ...
        @CalledByNative("Encoding")
        Encoding(String str, boolean z10, double d10, int i10, Integer num, Integer num2, Integer num3, Integer num4, Double d11, String str2, Long l10, boolean z11) {
            this.rid = str;
            this.active = z10;

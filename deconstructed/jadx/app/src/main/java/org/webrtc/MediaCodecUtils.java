...
class MediaCodecUtils {
    ...
    static /* synthetic */ class C111541 {
    ...
    static Map<String, String> getCodecProperties(VideoCodecMimeType videoCodecMimeType, boolean z10) {
        int i10 = C111541.$SwitchMap$org$webrtc$VideoCodecMimeType[videoCodecMimeType.ordinal()];

...
public class ScreenCapturerAndroid implements VideoCapturer, VideoSink {
    ...
    class RunnableC111711 implements Runnable {
        RunnableC111711() {
        }
    ...
    class RunnableC111722 implements Runnable {
        RunnableC111722() {
        }
    ...
    public synchronized void changeCaptureFormat(int i10, int i11, int i12) {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.surfaceTextureHelper.getHandler(), new RunnableC111722());
    }
    ...
    public synchronized void stopCapture() {
        checkNotDisposed();
        ThreadUtils.invokeAtFrontUninterruptibly(this.surfaceTextureHelper.getHandler(), new RunnableC111711());
    }
}

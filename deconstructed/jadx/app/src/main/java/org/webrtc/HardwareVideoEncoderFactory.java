...
public class HardwareVideoEncoderFactory implements VideoEncoderFactory {
    ...
    static /* synthetic */ class C111421 {
    ...
    private MediaCodecInfo findCodecForType(VideoCodecMimeType videoCodecMimeType) {
        ...
        while (true) {
            ...
            try {
                ...
                Logging.m46074e(TAG, "Cannot retrieve encoder codec info", e10);
            }
    ...
    private boolean isHardwareSupportedInCurrentSdk(MediaCodecInfo mediaCodecInfo, VideoCodecMimeType videoCodecMimeType) {
        ...
        int i10 = C111421.$SwitchMap$org$webrtc$VideoCodecMimeType[videoCodecMimeType.ordinal()];
        if (i10 == 1) {
    ...
    public HardwareVideoEncoderFactory(EglBase.Context context, boolean z10, boolean z11, Predicate<MediaCodecInfo> predicate) {
        if (context instanceof EglBase14.Context) {
            ...
            Logging.m46076w(TAG, "No shared EglBase.Context.  Encoders will not use texture mode.");

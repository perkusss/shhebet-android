...
public class PeerConnectionFactory {
    ...
    public static class Builder {
        ...
        /* synthetic */ Builder(C11193Z c11193z) {
            this();
        }
    ...
    public static class InitializationOptions {
        ...
        /* synthetic */ InitializationOptions(Context context, String str, boolean z10, NativeLibraryLoader nativeLibraryLoader, String str2, Loggable loggable, Logging.Severity severity, C11193Z c11193z) {
    ...
    public static void initialize(InitializationOptions initializationOptions) {
        ...
        if (loggable != null) {
            ...
            Logging.m46072d(TAG, "PeerConnectionFactory was initialized without an injected Loggable. Any existing Loggable will be deleted.");
    ...
    private void onNetworkThreadReady() {
        ...
        Logging.m46072d(TAG, "onNetworkThreadReady");
    }
    ...
    private void onSignalingThreadReady() {
        ...
        Logging.m46072d(TAG, "onSignalingThreadReady");
    }
    ...
    private void onWorkerThreadReady() {
        ...
        Logging.m46072d(TAG, "onWorkerThreadReady");
    }
    ...
    private static void printStackTrace(ThreadInfo threadInfo, boolean z10) {
        ...
        if (stackTrace.length > 0) {
            Logging.m46076w(TAG, name + " stacktrace:");
            for (StackTraceElement stackTraceElement : stackTrace) {
                Logging.m46076w(TAG, stackTraceElement.toString());
            }
        }
        if (z10) {
            Logging.m46076w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
            Logging.m46076w(TAG, "pid: " + Process.myPid() + ", tid: " + threadInfo.tid + ", name: " + name + "  >>> WebRTC <<<");

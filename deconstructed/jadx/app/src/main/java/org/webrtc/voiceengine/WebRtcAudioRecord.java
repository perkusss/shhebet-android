...
public class WebRtcAudioRecord {
    ...
    public static class AudioSamples {
        ...
        /* synthetic */ AudioSamples(AudioRecord audioRecord, byte[] bArr, C11254a c11254a) {
    ...
    private boolean enableBuiltInAEC(boolean z10) {
        ...
        Logging.m46073e(TAG, "Built-in AEC is not supported on this platform");
        return false;
    }
    ...
    private boolean enableBuiltInNS(boolean z10) {
        ...
        Logging.m46073e(TAG, "Built-in NS is not supported on this platform");
        return false;
    }
    ...
    private int initRecording(int i10, int i11) {
        ...
        try {
            AudioRecord audioRecord = new AudioRecord(audioSource, i10, iChannelCountToConfiguration, 2, iMax);
    ...
    public static synchronized void setAudioSource(int i10) {
        Logging.m46076w(TAG, "Audio source is changed from: " + audioSource + " to " + i10);
        audioSource = i10;
    }

    public static void setErrorCallback(WebRtcAudioRecordErrorCallback webRtcAudioRecordErrorCallback) {
        Logging.m46072d(TAG, "Set error callback");

...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        if (iArr[0] == 1) {
            ...
            Logging.m46073e(TAG, "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
    ...
    private static int compileShader(int i10, String str) {
        ...
        Logging.m46073e(TAG, "Compile error " + GLES20.glGetShaderInfoLog(iGlCreateShader) + " in shader:\n" + str);
    ...
    public void release() {
        Logging.m46072d(TAG, "Deleting shader.");
        int i10 = this.program;
        if (i10 != -1) {

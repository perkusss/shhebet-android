...
public class FileVideoCapturer implements VideoCapturer {
    ...
    private final TimerTask tickTask = new C111351();

    /* JADX INFO: renamed from: org.webrtc.FileVideoCapturer$1 */
    class C111351 extends TimerTask {
        C111351() {
        }
    ...
    private static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                ...
                if (i10 == 10) {
                    ...
                    Logging.m46072d(TAG, "Color space: " + strSubstring);
                    ...
                    Logging.m46072d(TAG, "frame dim: (" + i11 + ", " + i12 + ")");
                    return;
                }
                sb2.append((char) i10);
            }
        ...
        public void close() {
            try {
                ...
                Logging.m46074e(TAG, "Problem closing file", e10);
            }
        }
    ...
    public FileVideoCapturer(String str) throws IOException {
        try {
            ...
            Logging.m46072d(TAG, "Could not open video file: " + str);
            throw e10;
        }
    }

...
public class C5001m extends AbstractC5009u {

    /* JADX INFO: renamed from: N2 */
    private C0870h f20382N2;

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: cc */
    public /* synthetic */ AbstractC4394i.f m19222cc(AbstractC4394i.f fVar) {
        this.f20382N2 = new C13312D().m54178s0(this.f17545p0, this.f20416x2, this.f20413u2, m17136h4(), m17131C4());
    ...
    public static synchronized C5001m m19223dc(Bundle bundle) {
        C5001m c5001m;
        c5001m = new C5001m();
        c5001m.setArguments(bundle);
        return c5001m;
    }
    ...
    protected void mo16565D8() {
        super.mo16565D8();
        FirebaseAnalytics.getInstance(AppHelper.m34957S()).m33959a("group_private_chat_reply_page", new Bundle());
    }
    ...
    protected void mo16574S9() {
        this.f17542o0 = new C8215a(getActivity(), C8215a.b.GROUP_REPLY, this.f17545p0, this.f20399A2, this.f20416x2, this.f20414v2, this.f20407I2, Boolean.valueOf(mo16660A8()), this.f20402D2, m17136h4(), m17141p4(), m17142q4());
    }
    ...
    protected AbstractC2470o<AbstractC4394i.f> mo16578e4() {
        return super.mo16578e4().m10687o(new C5000l(this));
    }
    ...
    protected EnumC13633a mo16583n9() {
        return EnumC13633a.GROUP_PRIVATE_REPLY_CHAT;
    }
    ...
    class a implements InterfaceC2472q<Boolean> {
        ...
        public void onSuccess(Boolean bool) {
            ((AbstractC4345U0) C5001m.this).f17468G0.setText(R.string.reply);
            ((AbstractC4345U0) C5001m.this).f17466F0.setVisibility(8);
        }

        @Override // p213Le.InterfaceC2472q
        /* JADX INFO: renamed from: c */
        public void mo631c(InterfaceC3113b interfaceC3113b) {
            ((AbstractC0337f) C5001m.this).f2693n.mo13104c(interfaceC3113b);
        }

...
public class C4999k extends AbstractC5009u {

    /* JADX INFO: renamed from: N2 */
    protected AbstractC3838B f20377N2;

    /* JADX INFO: renamed from: O2 */
    protected C0870h f20378O2;

    /* JADX INFO: renamed from: ac.k$b */
    static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f20380a[EnumC0282e.MESSAGE_IMAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f20380a[EnumC0282e.MESSAGE_AUDIO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f20380a[EnumC0282e.MESSAGE_VIDEO.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f20380a[EnumC0282e.MESSAGE_FILE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f20380a[EnumC0282e.MESSAGE_STICKER.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f20380a[EnumC0282e.MESSAGE_GIF_VIDEO.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f20380a[EnumC0282e.MESSAGE_GIF_IMAGE.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f20380a[EnumC0282e.MESSAGE_CALENDAR.ordinal()] = 9;
    ...
    public static /* synthetic */ void m19211Yb(C4999k c4999k, C10934j c10934j) {
        c4999k.getClass();
        switch (b.f20380a[EnumC0282e.m1174b(Integer.valueOf(c10934j.f48713d)).ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
            ...
            case 9:
                if (c10934j.f48711b != null) {
                    c4999k.m19217ec(c10934j.f48714e, c10934j.f48712c + 1);
                } else {
                    c4999k.m19217ec(true, 0);
                }
                break;
        }
    }
    ...
    public static /* synthetic */ void m19212Zb(C4999k c4999k, C10941q c10941q) {
        c4999k.getClass();
        if (c10941q.f48745b == null || c10941q.f48747d) {
            c4999k.m19217ec(true, 0);
        } else {
            c4999k.m19217ec(!r0.booleanValue(), (c10941q.f48746c / 2) + 1);
        }
    }

    /* JADX INFO: renamed from: ac */
    public static /* synthetic */ void m19213ac(C4999k c4999k, C10921C c10921c) {
        c4999k.getClass();
        switch (b.f20380a[EnumC0282e.m1174b(Integer.valueOf(c10921c.f48675d)).ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
            ...
            case 9:
                ...
                if (bool != null) {
                    c4999k.m19217ec(bool.booleanValue(), (c10921c.f48674c / 2) + 1);
                } else {
                    c4999k.m19217ec(true, 0);
                }
                break;
    ...
    public static synchronized C4999k m19216dc(Bundle bundle) {
        C4999k c4999k;
        c4999k = new C4999k();
        c4999k.setArguments(bundle);
        return c4999k;
    }

    /* JADX INFO: renamed from: ec */
    private void m19217ec(boolean z10, int i10) {
        AbstractC3838B abstractC3838B = this.f20377N2;
        ...
        try {
            ...
            if (c0870hM54178s0 != null) {
                this.f20378O2 = c0870hM54178s0;
                this.f20377N2.mo15504X(c0870hM54178s0);
    ...
    protected void mo16565D8() {
        super.mo16565D8();
        FirebaseAnalytics.getInstance(AppHelper.m34957S()).m33959a("group_private_replies_page", new Bundle());
    }

    @Override // p416Xb.AbstractC4345U0
    /* JADX INFO: renamed from: Da */
    protected AbstractC3838B mo16967Da() {
        return this.f20377N2;
    }
    ...
    public void mo17009ea(C10941q c10941q) {
        ...
        if (handler == null || this.f20377N2 == null) {
            return;
        }
        handler.post(new RunnableC4996h(this, c10941q));
    }

    @Override // p416Xb.AbstractC4345U0
    /* JADX INFO: renamed from: fa */
    protected void mo16670fa(C10934j c10934j) {
        if (this.f2692m == null || c10934j.f48710a != this.f20413u2.longValue() || this.f20377N2 == null) {
            return;
        }
        this.f2692m.post(new RunnableC4997i(this, c10934j));
    }
    ...
    protected EnumC13633a mo16583n9() {
        return EnumC13633a.GROUP_PRIVATE_REPLIES;
    }
    ...
    protected void mo17020qa(C10921C c10921c) {
        if (this.f2692m == null || c10921c.f48672a != this.f20413u2.longValue() || this.f20377N2 == null) {
            return;
        }
        this.f2692m.post(new RunnableC4998j(this, c10921c));
    }
    ...
    protected void mo16591z8() {
        super.mo16591z8();
        C0870h c0870hM54178s0 = new C13312D().m54178s0(this.f17545p0, this.f20416x2, this.f20413u2, m17136h4(), m17131C4());
        this.f20378O2 = c0870hM54178s0;
        this.f20410L2 = EnumC0282e.m1174b(Integer.valueOf((c0870hM54178s0.m4296F0() == null || this.f20378O2.m4296F0().intValue() == 0) ? EnumC0282e.MESSAGE_TEXT.f1999a : this.f20378O2.m4296F0().intValue()));
        AbstractC3838B abstractC3838BM15163b = C3731h.m15163b(this.f20378O2, mo16564B9());
        this.f20377N2 = abstractC3838BM15163b;
        this.f17553s0.mo15159k0(Arrays.asList(abstractC3838BM15163b), Boolean.TRUE);
        this.f20377N2.m15508b0(this.f20417y2);
        this.f20377N2.m15493L((InterfaceC2406a) getActivity());
        this.f20377N2.m15501U(true);
        this.f20377N2.m15496O(new a());
    }

    /* JADX INFO: renamed from: ac.k$a */
    class a implements AbstractC3838B.k {
        ...
        public boolean mo15167B(AbstractC3838B abstractC3838B) {
            return C4999k.this.mo15231B(abstractC3838B);
        }
        ...
        public Integer mo15193a(C4950h.a aVar) {
            return Integer.valueOf(C4950h.m19051d(C4999k.this.getView(), C4999k.this.m17138k4(), aVar));
        }

        @Override // p382Vb.AbstractC3838B.k
        /* JADX INFO: renamed from: d */
        public Long mo15198d() {
            return ((AbstractC0337f) C4999k.this).f2684e;
        }

        @Override // p382Vb.AbstractC3838B.k
        /* JADX INFO: renamed from: l */
        public boolean mo15204l(AbstractC3838B abstractC3838B) {
            return C4999k.this.mo15242l(abstractC3838B);
        }

        @Override // p382Vb.AbstractC3838B.k
        /* JADX INFO: renamed from: m */
        public void mo15205m(String str) {
            C4999k.this.mo15243m(str);
        }

        @Override // p382Vb.AbstractC3838B.k
        /* JADX INFO: renamed from: n */
        public void mo15207n(AbstractC3838B abstractC3838B) {
            C4999k.this.mo15244n(abstractC3838B);
        }

        @Override // p382Vb.AbstractC3838B.k
        /* JADX INFO: renamed from: o */
        public boolean mo15209o(AbstractC3838B abstractC3838B) {
            return C4999k.this.mo15245o(abstractC3838B);
        }

        @Override // p382Vb.AbstractC3838B.k
        /* JADX INFO: renamed from: q */
        public boolean mo15212q(AbstractC3838B abstractC3838B) {
            return C4999k.this.mo15247q(abstractC3838B);
        }

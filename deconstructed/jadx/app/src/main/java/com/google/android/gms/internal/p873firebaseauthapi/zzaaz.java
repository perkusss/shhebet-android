...
final class zzaaz extends zzacz<Object, InterfaceC12242b0> {
    private final zzags zzy;

    public zzaaz(AbstractC7959g abstractC7959g, String str) {
        super(2);
        C6923t.m29819n(abstractC7959g, "credential cannot be null");
        this.zzy = C12240a0.m50105a(abstractC7959g, str).zza(false);
    }

        ...
        while (i10 < i12) {
            ...
            if (zzdz.zze(b11)) {
                ...
                while (i15 < i12) {
                    ...
                    i15++;
                    zzdz.zzb(b12, cArr, i16);
                    i16++;
                }
                i14 = i16;
                i10 = i15;
            } else if (zzdz.zzf(b11)) {
                if (i15 >= i12) {
                    throw zzbk.zzbu();
                }
                i10 += 2;
                zzdz.zzb(b11, bArr[i15], cArr, i14);
                i14++;
            } else if (zzdz.zzg(b11)) {
                if (i15 >= i12 - 1) {
                    throw zzbk.zzbu();
                }
                int i17 = i10 + 2;
                i10 += 3;
                zzdz.zzb(b11, bArr[i15], bArr[i17], cArr, i14);
                i14++;
            } else {
                if (i15 >= i12 - 2) {
                    throw zzbk.zzbu();
                ...
                byte b14 = bArr[i10 + 2];
                i10 += 4;
                zzdz.zzb(b11, b13, b14, bArr[i18], cArr, i14);
                i14 += 2;
            }
        }

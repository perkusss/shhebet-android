...
public final class zzcb {
    ...
    static {
        ...
        for (zzcb zzcbVar52 : zzcbVarArrValues) {
            zzjb[zzcbVar52.f30414id] = zzcbVar52;
        }
    }
    ...
    private zzcb(String str, int i10, int i11, zzcd zzcdVar, zzcq zzcqVar) {
        ...
        this.zziy = zzcdVar;
        this.zzix = zzcqVar;
        int i13 = zzcc.zzje[zzcdVar.ordinal()];
        this.zziz = (i13 == 1 || i13 == 2) ? zzcqVar.zzbq() : null;
        this.zzja = (zzcdVar != zzcd.SCALAR || (i12 = zzcc.zzjf[zzcqVar.ordinal()]) == 1 || i12 == 2 || i12 == 3) ? false : true;
    }

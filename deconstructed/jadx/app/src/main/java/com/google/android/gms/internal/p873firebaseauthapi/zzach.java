...
import com.google.firebase.auth.C7942V;
import com.google.firebase.auth.C7943W;
import com.google.firebase.auth.C7968j;
import com.google.firebase.auth.C7970k;
import com.google.firebase.auth.C7972l;
import com.google.firebase.auth.C7974m;
import com.google.firebase.auth.C7976n;
import com.google.firebase.auth.C7980p;
import com.google.firebase.auth.C7982q;
import com.google.firebase.auth.C7986s;
import com.google.firebase.auth.C7988t;
import com.google.firebase.auth.C7990u;
import com.google.firebase.auth.FirebaseAuth;
import p687o6.C10891d;
import p687o6.C10901n;
import p687o6.C10903p;
import p687o6.C10905r;
import p737r7.C11663a;
import p765t6.C12257j;
...
public final class zzach {
    ...
    */
    public static C10901n zza(Status status) {
        int iM29342z1 = status.m29342z1();
        String strZza = zza(zzb(iM29342z1), status);
        if (iM29342z1 == 17020) {
            return new C10903p(zza("A network error (such as timeout, interrupted connection or unreachable host) has occurred.", status));
        }
        if (iM29342z1 != 17021) {
            if (iM29342z1 != 17051) {
                if (iM29342z1 == 17052) {
                    return new C10905r(strZza);
                }
                switch (iM29342z1) {
                    case 17000:
                    case 17002:
                    ...
                    case 18001:
                    case 18002:
                        return new C7972l(zza(iM29342z1), strZza);
                    case 17007:
                    case 17012:
                        return new C7986s(zza(iM29342z1), strZza);
                    case 17010:
                        return new C10905r(zza("We have blocked all requests from this device due to unusual activity. Try again later.", status));
                    case 17080:
                        return new C10891d(strZza);
                    case 17200:
                        return new C7942V(zza(iM29342z1), strZza);
                    case 17495:
                        return new C11663a(zza("Please sign in before trying to get a token.", status));
                    case 17499:
                        return new C10901n(zza("An internal error has occurred.", status));
                    default:
                        switch (iM29342z1) {
                            case 17014:
                                return new C7982q(zza(iM29342z1), strZza);
                            case 17015:
                                return new C10901n(zza("User has already been linked to the given provider.", status));
                            case 17016:
                                return new C10901n(zza("User was not linked to an account with the given provider.", status));
                            case 17017:
                                break;
                            default:
                                switch (iM29342z1) {
                                    ...
                                    case 17025:
                                        break;
                                    case 17026:
                                        return new C7988t(zza(iM29342z1), strZza, status.m29337A1());
                                    default:
                                        switch (iM29342z1) {
                                            case 17028:
                                                break;
                                            case 17029:
                                            case 17030:
                                                return new C7968j(zza(iM29342z1), strZza);
                                            case 17031:
                                            case 17032:
                                            case 17033:
                                                return new C7970k(zza(iM29342z1), strZza);
                                            case 17034:
                                            case 17035:
                                                break;
                                            default:
                                                switch (iM29342z1) {
                                                    ...
                                                    default:
                                                        switch (iM29342z1) {
                                                            case 17056:
                                                                return new C7943W(zza(iM29342z1), strZza);
                                                            default:
                                                                switch (iM29342z1) {
                                                                    case 17061:
                                                                        return new C10903p(zza("There was a failure in the connection between the web widget and the Firebase Auth backend.", status));
                                                                    case 17062:
                                                                    case 17065:
                                                                        break;
                                                                    case 17063:
                                                                    ...
                                                                    default:
                                                                        switch (iM29342z1) {
                                                                            ...
                                                                            case 17075:
                                                                                break;
                                                                            default:
                                                                                return new C10901n("An internal error has occurred.");
                                                                        }
                                                                    case 17064:
                                                                        break;
                                                                }
                                                            case 17057:
                                                            case 17058:
                                                                return new C7990u(zza(iM29342z1), strZza);
                                                        }
                                                        break;
                                                }
                                                break;
            ...
            return new C7974m(zza(iM29342z1), strZza);
        }
        return new C7976n(zza(iM29342z1), strZza);
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof C7972l) {
            return ((C7972l) exc).m34107a().endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C7972l) {
            return ((C7972l) exc).m34107a().endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }

    public static C10901n zza(Status status, AbstractC7959g abstractC7959g, String str, String str2) {
        int iM29342z1 = status.m29342z1();
        if (iM29342z1 != 17012 && iM29342z1 != 17007 && iM29342z1 != 17025) {
            return zza(status);
        }
        return new C7986s(zza(iM29342z1), zza(zzb(iM29342z1), status)).m34108b(abstractC7959g).m34109c(str).m34110d(str2);
    }

    public static C7980p zza(FirebaseAuth firebaseAuth, zzym zzymVar, AbstractC7992v abstractC7992v) {
        zzz.zza(firebaseAuth);
        zzz.zza(zzymVar);
        Pair<String, String> pair = zza.get(17078);
        return new C7980p((String) pair.first, (String) pair.second, C12257j.m50140z1(zzymVar, firebaseAuth, abstractC7992v));
    }
    ...
    private static String zza(String str, Status status) {
        if (TextUtils.isEmpty(status.m29337A1())) {
            return str;
        }
        return String.format(str + " [ %s ]", status.m29337A1());
    }

    public static boolean zza(Exception exc) {
        if (exc instanceof C7972l) {
            return ((C7972l) exc).m34107a().endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}

...
jadx.core.utils.exceptions.JadxRuntimeException: Init of enum field 'zzjg' uses external variables
...
public final class zzbm {
    ...
    static {
        ...
        zzji = zzbmVar4;
        zzbm zzbmVar5 = new zzbm("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(0.0d));
        zzjj = zzbmVar5;
    ...
    private zzbm(String str, int i10, Class cls, Class cls2, Object obj) {
        this.zzjp = cls;
        this.zzjq = cls2;
        this.zzjr = obj;
    }

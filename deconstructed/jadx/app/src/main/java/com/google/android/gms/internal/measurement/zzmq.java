...
final class zzmq extends zzmr {
    ...
    @Override // com.google.android.gms.internal.measurement.zzmr
    final String zza(byte[] bArr, int i10, int i11) throws zzkb {
        if ((i10 | i11 | ((bArr.length - i10) - i11)) >= 0) {
            ...
            while (i10 < i12) {
                ...
                if (b11 >= 0) {
                    ...
                    if (i15 < i12) {
                        i10 += 2;
                        zzmo.zza(b11, bArr[i15], cArr, i14);
                        i14++;
                    } else {
                        throw zzkb.zzd();
                    }
                    ...
                    if (i15 < i12 - 1) {
                        int i17 = i10 + 2;
                        i10 += 3;
                        zzmo.zza(b11, bArr[i15], bArr[i17], cArr, i14);
                        i14++;
                    } else {
                        throw zzkb.zzd();
                    }
                    ...
                    byte b14 = bArr[i10 + 2];
                    i10 += 4;
                    zzmo.zza(b11, b13, b14, bArr[i18], cArr, i14);
                    i14 += 2;
                } else {
                    throw zzkb.zzd();
                }

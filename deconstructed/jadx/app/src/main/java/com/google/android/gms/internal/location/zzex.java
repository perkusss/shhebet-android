...
public abstract class zzex extends zzeu implements List, RandomAccess {
    ...
    static zzex zzk(Object[] objArr, int i10) {
        return i10 == 0 ? zzey.zza : new zzey(objArr, i10);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (list instanceof RandomAccess) {
            for (int i10 = 0; i10 < size; i10++) {
                if (!zzeq.zza(get(i10), list.get(i10))) {
                    return false;
                }
            }
            return true;
    ...
    public zzex subList(int i10, int i11) {
        zzer.zze(i10, i11, size());
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? zzey.zza : new zzew(this, i10, i12);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzl, reason: merged with bridge method [inline-methods] */
    public final zzfa listIterator(int i10) {
        zzer.zzd(i10, size(), "index");
        return isEmpty() ? zza : new zzev(this, i10);
    }
}

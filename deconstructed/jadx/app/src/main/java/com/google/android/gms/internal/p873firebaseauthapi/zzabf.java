...
final class zzabf extends zzacz<Object, InterfaceC12242b0> {
    private final zzyi zzy;

    public zzabf(C7928G c7928g, String str) {
        super(2);
        C6923t.m29819n(c7928g, "credential cannot be null");
        this.zzy = new zzyi(c7928g.m34035D1(false), str);
    }

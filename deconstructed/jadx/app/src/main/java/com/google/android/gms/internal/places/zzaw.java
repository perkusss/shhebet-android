...
jadx.core.utils.exceptions.JadxRuntimeException: Init of enum field 'zzfn' uses external variables
...
public final class zzaw {
    ...
    static {
        ...
        for (zzaw zzawVar52 : zzawVarArrValues) {
            zzhq[zzawVar52.f30415id] = zzawVar52;
        }
    }

    private zzaw(String str, int i10, int i11, zzay zzayVar, zzbm zzbmVar) {
        int i12;
        this.f30415id = i11;
        this.zzhn = zzayVar;
        this.zzhm = zzbmVar;
        int i13 = zzaz.zzhz[zzayVar.ordinal()];
        if (i13 == 1 || i13 == 2) {
            this.zzho = zzbmVar.zzbw();
        } else {
            this.zzho = null;
        }
        this.zzhp = (zzayVar != zzay.SCALAR || (i12 = zzaz.zzia[zzbmVar.ordinal()]) == 1 || i12 == 2 || i12 == 3) ? false : true;
    }

...
/* JADX INFO: renamed from: com.google.android.gms.measurement.internal.x */
/* JADX INFO: loaded from: classes2.dex */
public final class C7415x extends AbstractC7433z3 {
    ...
    protected final boolean mo30564o() {
        ...
        this.f31635c = TimeUnit.MINUTES.convert(calendar.get(15) + calendar.get(16), TimeUnit.MILLISECONDS);
        Locale locale = Locale.getDefault();
        String language = locale.getLanguage();
        Locale locale2 = Locale.ENGLISH;
        this.f31636d = language.toLowerCase(locale2) + "-" + locale.getCountry().toLowerCase(locale2);
        return false;
    }

    /* JADX INFO: renamed from: p */
    public final long m31202p() {
        m31248k();
        return this.f31635c;
    }

    /* JADX INFO: renamed from: q */
    public final String m31203q() {
        m31248k();
        return this.f31636d;
    }

...
interface zzale {
    ...
    <T> void zza(T t10, zzalh<T> zzalhVar, zzaiq zzaiqVar);

    void zza(List<Boolean> list);

    @Deprecated
    <T> void zza(List<T> list, zzalh<T> zzalhVar, zzaiq zzaiqVar);

    <K, V> void zza(Map<K, V> map, zzakg<K, V> zzakgVar, zzaiq zzaiqVar);

    float zzb();

    <T> void zzb(T t10, zzalh<T> zzalhVar, zzaiq zzaiqVar);

    void zzb(List<zzaho> list);

    <T> void zzb(List<T> list, zzalh<T> zzalhVar, zzaiq zzaiqVar);

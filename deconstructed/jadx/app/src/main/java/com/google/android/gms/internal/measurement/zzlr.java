...
interface zzlr {
    ...
    <T> void zza(T t10, zzlu<T> zzluVar, zzjg zzjgVar);

    void zza(List<Boolean> list);

    @Deprecated
    <T> void zza(List<T> list, zzlu<T> zzluVar, zzjg zzjgVar);

    <K, V> void zza(Map<K, V> map, zzkt<K, V> zzktVar, zzjg zzjgVar);

    float zzb();

    <T> void zzb(T t10, zzlu<T> zzluVar, zzjg zzjgVar);

    void zzb(List<zzik> list);

    <T> void zzb(List<T> list, zzlu<T> zzluVar, zzjg zzjgVar);

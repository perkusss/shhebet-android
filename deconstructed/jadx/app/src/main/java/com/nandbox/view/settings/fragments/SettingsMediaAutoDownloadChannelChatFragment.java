...
@Keep
public class SettingsMediaAutoDownloadChannelChatFragment extends AbstractSharedPreferencesOnSharedPreferenceChangeListenerC8607a implements SettingsFragmentInfoProvider {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        setPreferencesFromResource(R.xml.preferences_settings_media_download_channel_chat_screen, str);
    }
}

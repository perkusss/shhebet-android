...
@Keep
public class SettingsMediaAutoDownloadGroupChatFragment extends AbstractSharedPreferencesOnSharedPreferenceChangeListenerC8607a implements SettingsFragmentInfoProvider {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        setPreferencesFromResource(R.xml.preferences_settings_media_download_group_chat_screen, str);
    }
}

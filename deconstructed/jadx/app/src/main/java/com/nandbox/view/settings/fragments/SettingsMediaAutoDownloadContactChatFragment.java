...
@Keep
public class SettingsMediaAutoDownloadContactChatFragment extends AbstractSharedPreferencesOnSharedPreferenceChangeListenerC8607a implements SettingsFragmentInfoProvider {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        setPreferencesFromResource(R.xml.preferences_settings_media_download_contact_chat_screen, str);
    }
}

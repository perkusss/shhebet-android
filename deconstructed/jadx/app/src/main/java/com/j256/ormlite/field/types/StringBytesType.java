...
public class StringBytesType extends BaseDataType {
    ...
    public Object javaToSqlArg(FieldType fieldType, Object obj) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Could not convert string with charset name: " + charsetName, e10);
        }
    }
    ...
    public Object parseDefaultString(FieldType fieldType, String str) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Could not convert default string: " + str, e10);
        }
    }

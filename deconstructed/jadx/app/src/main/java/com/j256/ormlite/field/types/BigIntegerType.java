...
public class BigIntegerType extends BaseDataType {
    ...
    public Object parseDefaultString(FieldType fieldType, String str) throws SQLException {
        try {
            ...
            throw SqlExceptionUtil.create("Problems with field " + fieldType + " parsing default BigInteger string '" + str + "'", e10);
        }
    }
    ...
    public Object sqlArgToJava(FieldType fieldType, Object obj, int i10) throws SQLException {
        try {
            ...
            throw SqlExceptionUtil.create("Problems with column " + i10 + " parsing BigInteger string '" + obj + "'", e10);
        }
    }

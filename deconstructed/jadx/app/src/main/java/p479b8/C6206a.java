...
final class C6206a {
    ...
    byte[] m27599a() {
        ...
        int iM14615h = this.f27853a.m14615h();
        int iM14618k = this.f27853a.m14618k();
        for (int i10 = 0; i10 < iM14615h; i10++) {
            int[] iArr = f27852b[i10];
            for (int i11 = 0; i11 < iM14618k; i11++) {
                int i12 = iArr[i11];
                if (i12 >= 0 && this.f27853a.m14612e(i11, i10)) {
                    int i13 = i12 / 6;

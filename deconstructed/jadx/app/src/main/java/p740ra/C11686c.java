...
public class C11686c extends AbstractC11684a {

    /* JADX INFO: renamed from: I */
    private final ImageView f50975I;

    /* JADX INFO: renamed from: J */
    private final TextView f50976J;

    public C11686c(View view, Context context, AbstractC11684a.a aVar) {
        super(view, context, aVar);
        view.setOnClickListener(new ViewOnClickListenerC11685b(this));
        this.f50975I = (ImageView) view.findViewById(R.id.image);
        this.f50976J = (TextView) view.findViewById(R.id.txt_name);
    }

    /* JADX INFO: renamed from: T */
    public static View m48133T(ViewGroup viewGroup) {
        return LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.holder_catalog_content_style_01, viewGroup, false);
    }

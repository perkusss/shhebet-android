...
final class C9389r {
    ...
    static String m39534a(String str) throws C2366l {
        ...
        for (Object[] objArr : f40358b) {
            if (objArr[0].equals(strSubstring)) {
                Object obj = objArr[1];
                return obj == f40357a ? m39536c(2, ((Integer) objArr[2]).intValue(), str) : m39535b(2, ((Integer) obj).intValue(), str);
            }
        }
        if (str.length() < 3) {
            throw C2366l.m10338a();
        ...
        for (Object[] objArr2 : f40359c) {
            if (objArr2[0].equals(strSubstring2)) {
                Object obj2 = objArr2[1];
                return obj2 == f40357a ? m39536c(3, ((Integer) objArr2[2]).intValue(), str) : m39535b(3, ((Integer) obj2).intValue(), str);
            }
        }
        for (Object[] objArr3 : f40360d) {
            if (objArr3[0].equals(strSubstring2)) {
                Object obj3 = objArr3[1];
                return obj3 == f40357a ? m39536c(4, ((Integer) objArr3[2]).intValue(), str) : m39535b(4, ((Integer) obj3).intValue(), str);
            }
        }
        if (str.length() < 4) {
            throw C2366l.m10338a();
        ...
        for (Object[] objArr4 : f40361e) {
            if (objArr4[0].equals(strSubstring3)) {
                Object obj4 = objArr4[1];
                return obj4 == f40357a ? m39536c(4, ((Integer) objArr4[2]).intValue(), str) : m39535b(4, ((Integer) obj4).intValue(), str);
            }
        }
        throw C2366l.m10338a();
    }
    ...
    /* JADX INFO: renamed from: b */
    private static String m39535b(int i10, int i11, String str) throws C2366l {
        if (str.length() < i10) {
            throw C2366l.m10338a();
        }
        ...
        String strM39534a = m39534a(str.substring(i12));
        if (strM39534a == null) {
            return str2;
        }
        return str2 + strM39534a;
    }

    /* JADX INFO: renamed from: c */
    private static String m39536c(int i10, int i11, String str) throws C2366l {
        String strSubstring = str.substring(0, i10);
        int length = i11 + i10;
        if (str.length() < length) {
            length = str.length();
        }
        String strSubstring2 = str.substring(i10, length);
        String str2 = "(" + strSubstring + ')' + strSubstring2;
        String strM39534a = m39534a(str.substring(length));
        if (strM39534a == null) {
            return str2;
        }
        return str2 + strM39534a;
